...
<p align="center">
  ...
  <a href="https://github.com/aachbarou" target="_blank">
...
<table>
  <tr>
    <td valign="top" width="55%">
      <h3>📝 About Me</h3>
      <p>
        I build web applications across the full stack. My primary focus is on robust backends with <b>Java</b> and <b>Go</b>, paired with modern frontends like <b>Vue 3</b> and <b>Angular</b>.
      </p>
      <p>
        <b>My Primary Stacks:</b>
      </p>
      <ul>
        <li>☕ <b>Backend:</b> Java (Spring Boot), Go (Microservices/APIs)</li>
        <li>🎨 <b>Frontend:</b> Vue 3 (Vite), Angular (TypeScript)</li>
        <li>🗄️ <b>Databases:</b> PostgreSQL, MySQL</li>
        <li>⚙️ <b>DevOps:</b> Docker, Docker Compose, Nginx</li>
      </ul>
    </td>
...
<h3 align="center">💻 How to Run These Projects</h3>

<details>
<summary><b>🔥 Run: Real-Time Forum (Go + JS)</b></summary>
<br>
Backend (Go):
<pre>
...
<details>
<summary><b>🦀 Run: 0-shell (Rust)</b></summary>
<br>
<pre>
